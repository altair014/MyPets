...
urlpatterns = [
    ...
    path(route= 'pet_create_route/', view=PetInformationCreateView.as_view(), name='pet_create_name'),
    path(route= 'pet_list_route/<int:contact>', view=PetListView.as_view(), name='pet_list_name'),
